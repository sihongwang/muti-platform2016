...
public class RedisUtil {
	...
	//Redis服务器IP
	private static String ADDR_ARRAY = "192.168.9.205";//FileUtil.getPropertyValue("/properties/redis.properties", "server");
...
//	private static String AUTH = FileUtil.getPropertyValue("/properties/redis.properties", "auth");
	...
	private static int MAX_WAIT = 1000;//FileUtil.getPropertyValueInt("/properties/redis.properties", "max_wait");;
 
	//超时时间
	private static int TIMEOUT = 1000;//FileUtil.getPropertyValueInt("/properties/redis.properties", "timeout");;
	 
	//在borrow一个jedis实例时，是否提前进行validate操作；如果为true，则得到的jedis实例均是可用的；
	private static boolean TEST_ON_BORROW = false;//FileUtil.getPropertyValueBoolean("/properties/redis.properties", "test_on_borrow");;
